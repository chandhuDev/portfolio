    ...
    <>
      <div id='Home' className='flex md:flex-none flex-col justify-center items-center w-full h-full overflow-x-hidden'>
          ...
          <div className='w-full p-8 md:hidden h-full flex flex-col md:gap-y-5 gap-y-2.5 md:pt-48 pt-8'>
                 ...
                 <h4 className='md:text-xl text-base font-bold'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis deleniti accusantium quidem sint veritatis aperiam eveniet aliquid iusto? Veniam unde </h4>
                 <button className='bg-black/80 hover:bg-black/70 hover:duration-300 text-white/40 w-3/4 inline-flex justify-center items-center rounded-xl py-3 px-4 home_button md:mt-6 mt-2'>
                      Connect Now<span className='ml-2 inline-block home_button_hover'><img src="data:image/png;base64,"/></span>
                 </button>
