...
const skills = () => {
  return (
    <>
      <div className='w-full h-full flex flex-col md:gap-y-12 gap-y-6 items-center justify-center mx-auto md:py-10 py-5' id='Skills'>
        <div className='w-3/4'>
          <div className='md:my-10 my-1.5 w-full flex justify-center items-center flex-col gap-1'>
        ...
        <div className='grid grid-cols-1 place-items-center md:m-12 m-0 md:mt-12 mt-6'>
